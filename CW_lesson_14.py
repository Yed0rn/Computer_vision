...
def detect_person(image):
    ...
    for i in range(detections.shape[2]):
        ...
        clas_id=detections[0,0,i,1]
        if clas_id == PERSON_CLASS_ID and confidence>CONF_THRESHOLD:
...
for file in files:
    ...
    cv2.putText(boxed,f'person: {conf:.2f}',(x1,y1-10),cv2.FONT_HERSHEY_SIMPLEX,1,(0,0,255))
