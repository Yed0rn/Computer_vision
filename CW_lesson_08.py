...
while True:
    ...
    faces=face_cascade.detectMultiScale(gray,1.1,5,minSize=(30,30)) #коефіцієнт зменшення зображення
    #print(faces)
    for (x,y,w,h) in faces:
        ...
        smile=smile_cascade.detectMultiScale(roi_gray,1.7,15,minSize=(20,20))
