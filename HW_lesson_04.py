import cv2
import numpy as np
img=cv2.imread('images/HW_4.png')
scale = 1
...
contours,hierarchy=cv2.findContours(img_copy,cv2.RETR_EXTERNAL,cv2.CHAIN_APPROX_SIMPLE)# Знаходження контурів RETR крайні зовнішні контури CHAIN_APPROX аппроксимація ставить кінцеві точки контурів
...
cv2.putText(img_copy_color,"Andrew",(120,170),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,0,255),2)
cv2.putText(img_copy_color,"Yehor",(320,170),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,0,255),2)
